...
echo "Installing GUI applications with Homebrew..."
...
echo "Installing useful applications with the App Store..."

# ✅ Install developer tools
mas install 497799835 # Xcode

# ✅ Install collaboration tools
mas install 803453959 # Slack#!/usr/bin/env zsh
...
# Set the wallpaper
__set_wallpaper "/tmp/wallpaper-work.jpg"#!/usr/bin/env zsh
